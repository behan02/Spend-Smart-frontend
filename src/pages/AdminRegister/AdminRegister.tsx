...
import Image from "../../assets/images/AdminRegister.png";
...
const AdminRegister: React.FC = () => {
  ...
  const handleSubmit = async (e: React.FormEvent<HTMLFormElement>): Promise<void> => {
    ...
    try {
      const response = await fetch(`https://localhost:7195/api/auth/register`, { // Fixed the fetch URL
        method: "POST",
        headers: { 
      ...
      if (err instanceof TypeError) {
        ...
        alert("Connection error. Please check your network or contact support.");
      } else {
